...
WebVRManager.prototype.displayVRButton = function(value) {
  if (value == ButtonVisibility.VISIBLE && this.hideButton == false) {
...
WebVRManager.prototype.setMode = function(mode) {
  switch (mode) {
    case Modes.INCOMPATIBLE:
      this.displayVRButton(ButtonVisibility.HIDE);
      break;
    case Modes.COMPATIBLE:
      this.displayVRButton(ButtonVisibility.VISIBLE);
...
WebVRManager.prototype.base64 = function(format, base64) {
  return 'url(data:' + format + ';base64,' + base64 + ')';
};
